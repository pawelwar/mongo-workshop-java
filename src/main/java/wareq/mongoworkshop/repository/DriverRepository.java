...
public class DriverRepository {
    ...
    /**
     * Get driver by the vehicle number
     */
    public Driver getByCarNumber(String vehicleNumber) {

        // TODO 1: Return a single Driver with selected vehicle plate number.

        // TODO 2: Create an index that guarantees the uniqueness of
        //  the vehicle number. All changes should be done in the "Vehicle" class.
        //  You can look at the "Driver" class. They are a few indexes already defined.
